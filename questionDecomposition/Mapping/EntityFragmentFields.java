...
public class EntityFragmentFields {
	...
	{
		String localPath = "./././";
		String filename = localPath+"data/DBpedia2016/fragments/id_mappings/16entity_id.txt";
		String fragmentFileName = localPath+"data/DBpedia2016/fragments/entity_RDF_fragment/16entity_fragment.txt";
