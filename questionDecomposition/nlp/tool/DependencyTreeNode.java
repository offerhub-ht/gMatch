...
public class DependencyTreeNode {
	...
	public ArrayList<DependencyTreeNode> neighborList = null;//Store all neighbors of a vertex
	...
	public DependencyTreeNode(Word w, String dep_father2child, DependencyTreeNode father) 
	{
		...
		this.neighborList = new ArrayList<DependencyTreeNode>();
		this.neighborList.add(father);
